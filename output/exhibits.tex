...
Variable & Control & Industry & Academic & Personal & P-value \\
\midrule
\input{tables/balance_vacc_intent.tex}
\\
\bottomrule
\end{tabular}
\begin{minipage}{\textwidth}
...
Variable & Control & Industry & Academic & Personal & P-value \\
\midrule
\input{tables/balance_vacc_experience.tex}
\\
\bottomrule
\end{tabular}
\begin{minipage}{\textwidth}
...
Variable & Control & Industry & Academic & Personal & P-value \\
\midrule
\input{tables/balance_trust_health.tex}
\\
\bottomrule
\end{tabular}
\begin{minipage}{\textwidth}
...
\label{tab:het_low_prior}
\centering
\begin{tabular}{lcccc}
\toprule
& \multicolumn{2}{c}{Post-Trial SE Estimate} & \multicolumn{2}{c}{Posterior Difference} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
& High Prior & Low Prior & High Prior & Low Prior \\
\midrule
\input{tables/het_low_prior.tex}
\\
\bottomrule
\end{tabular}
\begin{minipage}{\textwidth}
...
\label{tab:het_good_experience}
\centering
\begin{tabular}{lcccc}
\toprule
& \multicolumn{2}{c}{Post-Trial SE Estimate} & \multicolumn{2}{c}{Posterior Difference} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
& Bad Experience & Good Experience & Bad Experience & Good Experience \\
\midrule
\input{tables/het_good_experience.tex}
\\
\bottomrule
\end{tabular}
\begin{minipage}{\textwidth}
\vspace{0.5em}
\footnotesize
\textit{Notes:} OLS regression coefficients with robust standard errors in parentheses. Control arm is the omitted category. All specifications include controls. Good Experience: reported no side effects or mild side effects from prior flu vaccine. Bad Experience: reported moderate or severe side effects, or did not receive prior flu vaccine.
\end{minipage}
\end{table}
...
\vspace{0.5em}
\footnotesize
\textit{Notes:} OLS regression coefficients with robust standard errors in parentheses. Control arm is the omitted category. All specifications include controls. High Trust: trust\_trial $>$ 5 (above median). Low Trust: trust\_trial $\leq$ 5.
\end{minipage}
\end{table}
...
\vspace{0.5em}
\footnotesize
\textit{Notes:} OLS regression coefficients with robust standard errors in parentheses. Control arm is the omitted category. All specifications include controls. High Relevance: relevant\_trial $>$ 5 (above median). Low Relevance: relevant\_trial $\leq$ 5.
\end{minipage}
\end{table}
