...
point increase in believed personal risk. Tht is, people who think side effects are likely 
...
belief updating in industry and academic arm is about 3 percentage points, so the learning 
rate is 20 percent.
...
few people clicked on the link (1.5 percent in teh control group). 
...
provision reduced trustworthiness by 0.3-0.4 points. (Appendix Table \ref{tab:trust_relevance}.)
Negative effects on trustworthiness are consistent with our study sample's high baseline 
prior; seeing information far from a prior makes that information source appear less 
...
We plot the implied effects, by arm, outcome, and quality perception, in Figure 
\ref{fig:hte_quality}, 
...
are also large. At low perceived trial quality (a value of -1, the 8th percentile), the belief 
