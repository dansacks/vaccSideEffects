/*==============================================================================
    ...
    - main_maybe (split=0), main_maybe (split=1)
...
foreach split in high_prior bad_experience high_trust high_relevance {
    ...
    * Column titles for output
    local coltitles mtitles("SE (trial)" "SE (trial)" "Delta" "Delta" "Vacc Intent" "Vacc Intent")

    * .tex output: esttab followed by split label row
    esttab post_trial_0 post_trial_1 delta_0 delta_1 main_maybe_0 main_maybe_1 ///
    ...
    * Append split label row to .tex file
    ...
    file write _het_tex "`rowlab' & `lab0' & `lab1' & `lab0' & `lab1' & `lab0' & `lab1'" _n
    file close _het_tex
    ...
    * Append split label row to .md file
    ...
    file write _het_md "| `rowlab' | `lab0' | `lab1' | `lab0' | `lab1' | `lab0' | `lab1' |" _n
    file close _het_md
