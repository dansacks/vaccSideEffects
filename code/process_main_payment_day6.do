...
import delimited $directory/data/reward_day3.csv, clear
tempfile day3
duplicates drop
save `day3'
...
merge m:1 prolific_id using `day1', keep(1) nogen
drop pay


merge m:1 prolific_id using `day3', keep(1) nogen
drop pay
gen pay = "0.50"
...
outsheet prolific_id pay using $directory/data/reward_day6.csv, replace ///
	delimit(",") noquote
